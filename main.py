...
if __name__ == "__main__":
    ...
    auld_lang_syne = ["D4", "G4", "F#4", "G4", "B4", "A4", "G4", "A4", "B4", "G4", "G4", "B4", "D5", "E5", "E5",
                      "D5", "B4", "B4", "G4", "A4", "G4", "A4", "B4", "A4", "G4", "E4", "E4", "D4", "G4", "E5",
                      "D5", "B4", "B4", "G4", "A4", "G4", "A4", "E5", "D5", "B4", "B4", "D5", "E5", "E5",
                      "D5", "B4", "B4", "G4", "A4", "G4", "A4", "B4", "A4", "G4", "E4", "E4", "D4", "G4"]

    times = [beat, beat*1.5, beat/2, beat, beat, beat*1.5, beat/2, beat, beat, beat*1.5, beat/2, beat, beat, beat*3, beat,
             beat*1.5, beat/2, beat, beat, beat*1.5, beat/2, beat, beat/2, beat/2, beat*1.5, beat/2, beat, beat, beat*3, beat,
             beat*1.5, beat/2, beat, beat, beat*1.5, beat/2, beat, beat, beat*1.5, beat/2, beat, beat, beat*3, beat,
             beat*1.5, beat/2, beat, beat, beat*1.5, beat/2, beat, beat/2, beat/2, beat*1.5, beat/2, beat, beat, beat*3]
    ...
    step_duration = 1  # Time (seconds) to play at each step
    '''
    ...
    for note, duration in zip(auld_lang_syne, times):
        sine(frequency=notes[note], duration=duration)
